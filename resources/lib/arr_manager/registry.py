...
ACTION_REGISTRY = [
    ...
    _action("retention_preview", 33400, "Retention preview", "root", "retention_preview", 67,
            simple=False, requires_selection=False, media_types=()),
    _action("retention_cleanup", 33401, "Run retention cleanup", "root", "retention_cleanup", 68,
            simple=False, mutating=True, destructive=True, requires_selection=False, media_types=()),
    _action("retention_report", 33402, "Last retention report", "root", "retention_report", 69,
            simple=False, requires_selection=False, media_types=()),
    _action("retention_enable_periodic", 33403, "Enable periodic retention", "retention_settings",
            "retention_enable_periodic", 1, simple=False, mutating=True, destructive=True,
            requires_selection=False, media_types=()),
    _action("retention_disable_periodic", 33404, "Disable periodic retention", "retention_settings",
