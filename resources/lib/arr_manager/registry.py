...
ACTION_REGISTRY = [
    ...
    _action("retention_preview", 33500, "Retention preview", "root", "retention_preview", 67,
            simple=False, requires_selection=False, media_types=()),
    _action("retention_cleanup", 33501, "Run retention cleanup", "root", "retention_cleanup", 68,
            simple=False, mutating=True, destructive=True, requires_selection=False, media_types=()),
    _action("retention_report", 33502, "Last retention report", "root", "retention_report", 69,
            simple=False, requires_selection=False, media_types=()),
    _action("retention_enable_periodic", 33503, "Enable periodic retention", "retention_settings",
            "retention_enable_periodic", 1, simple=False, mutating=True, destructive=True,
            requires_selection=False, media_types=()),
    _action("retention_disable_periodic", 33504, "Disable periodic retention", "retention_settings",
            "retention_disable_periodic", 2, simple=False, mutating=True, requires_selection=False, media_types=()),
