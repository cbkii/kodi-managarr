...
ACTION_REGISTRY = [
    ...
    _action("retention", 33500, "Retention", "root", "retention_menu", 48, simple=True, requires_selection=False,
            submenu=True, media_types=()),
    _action("retention_preview", 33501, "Preview eligible media", "retention", "retention_preview", 481,
            simple=True, requires_selection=False, media_types=()),
    _action("retention_run", 33502, "Run cleanup now", "retention", "retention_run", 482, simple=True,
            mutating=True, destructive=True, requires_selection=False, media_types=()),
    _action("retention_exclude", 33503, "Exclude selected item", "retention", "retention_exclude", 483,
            simple=True, mutating=True),
    _action("retention_manage_exclusions", 33504, "Manage exclusions", "retention", "retention_manage_exclusions", 484,
            simple=False, mutating=True, requires_selection=False, media_types=()),
    _action("retention_enable", 33505, "Enable periodic cleanup", "retention", "retention_enable", 485,
            simple=False, mutating=True, destructive=True, requires_selection=False, media_types=()),
    _action("retention_disable", 33506, "Disable periodic cleanup", "retention", "retention_disable", 486,
            simple=False, mutating=True, requires_selection=False, media_types=()),
    _action("retention_report", 33507, "View last cleanup report", "retention", "retention_report", 487,
