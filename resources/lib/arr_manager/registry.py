...
ACTION_REGISTRY = [
    _action("request_search", 32986, "Request & Search", "root", "request_search", 5, simple=True, mutating=True),
    ...
    _action("interactive_search", 32987, "Interactive search", "root", "interactive_search", 25, simple=False, mutating=True,
    ...
    _action("dashboard", 32983, "Dashboard", "root", "dashboard", 45, simple=True, requires_selection=False,
            media_types=()),
    _action("find_subtitles", 32984, "Find subtitles", "root", "find_subtitles", 47, simple=True,
    ...
    _action("delete_replace", 32002, "Delete & Replace", "root", "delete_replace", 60, simple=True, mutating=True,
            destructive=True),
    _action("configure_request_defaults", 32990, "Configure Request & Search defaults", "root",
            "configure_request_defaults", 65, simple=False, requires_selection=False, media_types=()),
    _action("configure_subtitle_languages", 32985, "Configure subtitle languages", "root",
