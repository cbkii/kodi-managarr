...
MESSAGES = {
    ...
    "search_movie_done": (32820, "Radarr queued a search for {title}."),
    "search_series_done": (32821, "Sonarr queued a full series search for {title}."),
    "search_episode_done": (32822, "Sonarr queued a search for {title} S{season:02d}E{episode:02d}."),
    ...
    "movie_replace_done": (32853, "{blocklist} Deleted the file and queued a replacement search for {title}."),
    "episode_replace_done": (32854, "{blocklist} Deleted the file and queued a replacement search for {title} {episodes}."),
    "series_replace_done": (32855, "{blocklist} Deleted {files} files and queued a series search for {title}."),
    ...
    "movie_missing_search_queued": (32938, "{title} is already missing in Radarr; a recovery search was queued without another deletion or blocklist action."),
    "episode_missing_search_queued": (32939, "{title} S{season:02d}E{episode:02d} is already missing in Sonarr; a recovery search was queued without another deletion or blocklist action."),
}
