...
MESSAGES = {
    ...
    "retention_preview_label": (33500, "Retention preview"),
    "retention_cleanup_label": (33501, "Run retention cleanup"),
    "retention_report_label": (33502, "Last retention report"),
    "retention_enable_periodic_label": (33503, "Enable periodic retention"),
    "retention_disable_periodic_label": (33504, "Disable periodic retention"),
    "retention_category": (33510, "Retention"),
    "retention_category_help": (33511, "Preview or safely remove watched and age-eligible movies and episode files."),
    "retention_enabled_label": (33512, "Enable retention features"),
    "retention_enabled_help": (33513, "Master switch for retention preview, cleanup and periodic scheduling."),
    "retention_include_movies_label": (33514, "Include movies"),
    "retention_include_movies_help": (33515, "Allow eligible Radarr movies to appear in retention previews and runs."),
    "retention_include_episodes_label": (33516, "Include episodes"),
    "retention_include_episodes_help": (33517, "Allow eligible Sonarr episode files to appear in retention previews and runs."),
    "retention_watched_only_label": (33518, "Require watched state"),
    "retention_watched_only_help": (33519, "Protect unwatched media regardless of the enabled age criteria."),
    "retention_use_added_age_label": (33520, "Use age since added"),
    "retention_use_added_age_help": (33521, "Require or consider the newest available Kodi or Arr added timestamp."),
    "retention_added_days_label": (33522, "Minimum days since added"),
    "retention_added_days_help": (33523, "Protect media added more recently than this threshold."),
    "retention_use_watched_age_label": (33524, "Use age since watched"),
    "retention_use_watched_age_help": (33525, "Require or consider Kodi's last-played timestamp."),
    "retention_watched_days_label": (33526, "Minimum days since watched"),
    "retention_watched_days_help": (33527, "Protect media watched more recently than this threshold."),
    "retention_all_option": (33528, "All enabled criteria"),
    "retention_any_option": (33529, "Any enabled criterion"),
    "retention_criteria_mode_label": (33530, "Combine age criteria"),
    "retention_criteria_mode_help": (33531, "Choose whether all or any enabled age criteria must pass."),
    "retention_rating_label": (33532, "Protect movies rated at or above"),
    "retention_rating_help": (33533, "Use 0 to disable. When enabled, unrated movies also remain protected."),
    "retention_exclusions_label": (33534, "Explicit exclusions"),
    "retention_exclusions_help": (33535, "Separate entries with commas or semicolons: movie:<Kodi ID>, episode:<Kodi ID>, series:<Kodi TV show ID>, or season:<Kodi TV show ID>:<season>."),
    "retention_manual_dry_run_label": (33536, "Manual cleanup dry run"),
    "retention_manual_dry_run_help": (33537, "Preview intended manual deletions without changing Kodi, Radarr or Sonarr."),
    "retention_max_label": (33538, "Maximum deletions per run"),
    "retention_max_help": (33539, "Hard cap for each manual or periodic retention pass."),
    "retention_interval_label": (33540, "Periodic interval in hours"),
    "retention_interval_help": (33541, "Minimum delay between completed periodic retention passes."),
    "retention_background_dry_run_label": (33542, "Periodic cleanup dry run"),
    "retention_background_dry_run_help": (33543, "Keep periodic retention non-destructive until the preview evidence has been verified."),
    "retention_notifications_label": (33544, "Periodic notifications"),
    "retention_notifications_help": (33545, "Choose which completed periodic retention results Kodi displays."),
    "retention_errors_only_option": (33546, "Errors only"),
    "retention_deletions_errors_option": (33547, "Deletions and errors"),
    "retention_silent_option": (33548, "Silent"),
    "retention_enable_periodic_help": (33549, "Authorise and enable periodic retention using the current PIN state."),
    "retention_disable_periodic_help": (33550, "Disable periodic retention immediately without requiring a PIN."),
    "retention_preview_summary": (33551, "Found {eligible} eligible deletion target(s). Batch limit: {limit}."),
    "retention_preview_more": (33552, "... and {count} more eligible target(s)."),
    "retention_skipped_heading": (33553, "Protected or ineligible items:"),
    "retention_preview_heading": (33554, "Retention preview"),
    "retention_cleanup_heading": (33555, "Retention cleanup"),
    "retention_none_eligible": (33556, "No eligible retention targets were found."),
    "retention_cleanup_confirm": (33557, "Process up to {count} eligible target(s)?\n\nDry run: {dry_run}"),
    "retention_locked": (33558, "Another retention pass is already running."),
    "retention_cleanup_complete": (33559, "Retention cleanup complete"),
    "retention_periodic_enabled": (33560, "Periodic retention enabled; next pass is due in about {hours} hour(s)."),
    "retention_periodic_disabled": (33561, "Periodic retention disabled."),
    "retention_report_heading": (33562, "Last retention report"),
    "retention_no_report": (33563, "No retention report is available."),
    "retention_report_type": (33564, "Run type: {run_type}"),
    "retention_report_dry_run": (33565, "Dry run: {dry_run}"),
    "retention_report_counts": (33566, "Deleted: {deleted} · Planned: {planned} · Failed: {failed} · Skipped: {skipped}"),
    "retention_summary": (33567, "Deleted: {deleted}; planned: {planned}; failed: {failed}; skipped: {skipped}."),
    "retention_periodic_auth_changed": (33568, "Periodic retention was disabled because the PIN authorisation state changed."),
    "retention_progress": (33569, "Evaluating and revalidating retention targets"),
    "retention_processing": (33570, "Processing {name}"),
}
