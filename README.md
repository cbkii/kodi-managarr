...
Host-side tests do not replace a real Android Kodi run. Use the [`Android Kodi validation runbookb�(docs/ANDROID_KODI_VALIDATION.md) with disposable media. A release candidate remains optional; the practical release gate is green CI plus applicable checks in [`docs/RELEASE_CHECKLIST.md`](docs/RELEASE_CHECKLIST.md).
